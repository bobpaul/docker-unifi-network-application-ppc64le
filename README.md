# Unofficial PPC64le fork

**Build Instructions**

1. build the ubuntu-base image as `ghcr.io/linuxserver/baseimage-ubuntu:ppc64le-noble`
2. `docker build -t lscr.io/linuxserver/unifi-network-application:latest -f Dockerfile.ppc64le .`


## TODO

- [ ] Publish images
- [ ] Automation for upstream changes
- [ ] CI to build and publish docker images.
  - Update Jenkins to build and publish docker images (could use https://osuosl.org/services/powerdev/)
  - or maybe use [gaplib](https://github.com/ppc64le/gaplib) for self-hosted github action
